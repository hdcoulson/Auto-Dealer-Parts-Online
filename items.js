var items = [
    {
      mediaHeading: 'Brakes',
      itemDescription: 'When it comes to brakes – bigger is better. Adding a performance Big Brake kit makes sense because it allows you to improve the braking performance of your vehicle to compliment the performance gains from increased power and handling.',
    ...
    },
    {
      ...
      itemDescription: 'Increase performance with reusable Air Filters. The free-flowing design allows for maximum air to enter your engine with minimal resistance, free of damaging debris.',
    ...
    {
      mediaHeading: 'Wheels',
      itemDescription: 'Wheel design can make or break the look of a car. Every performance wheel incorporates the proper weight, offset and brake clearance to ensure that you get proper fit, finish and reliability.',
